...
/**
 * ViewPromotoresHistorialId generated by hbm2java
 */
public class ViewPromotoresHistorialId implements java.io.Serializable {
	...
	public ViewPromotoresHistorialId() {
	}

	public ViewPromotoresHistorialId(int id, String clave, String nombres,
	...
	public ViewPromotoresHistorialId(int id, String clave, String nombres,
			...
			String municipio, String cp, String region, Integer existe) {
		this.id = id;
		this.clave = clave;
		this.nombres = nombres;
		this.apellidoPaterno = apellidoPaterno;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ViewPromotoresHistorialId))
			return false;
		ViewPromotoresHistorialId castOther = (ViewPromotoresHistorialId) other;
