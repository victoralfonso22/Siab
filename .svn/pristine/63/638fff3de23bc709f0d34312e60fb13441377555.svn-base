...
/**
 * SorteoColaboradores generated by hbm2java
 */
public class SorteoColaboradores implements java.io.Serializable {
	...
	public SorteoColaboradores() {
	}

	public SorteoColaboradores(int idBoleto, int estatus, int idPremio) {
